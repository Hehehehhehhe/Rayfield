...
local RayfieldLibrary = {
	...
	Theme = {
		Default = {
			...
			Background = Color3.fromRGB(187, 136, 85),
			Topbar = Color3.fromRGB(85, 51, 17),
			Shadow = Color3.fromRGB(170, 119, 51),

			NotificationBackground = Color3.fromRGB(170, 119, 51),
			NotificationActionsBackground = Color3.fromRGB(187, 136, 85),

			TabBackground = Color3.fromRGB(187, 136, 85),
			TabStroke = Color3.fromRGB(85, 51, 17),
			TabBackgroundSelected = Color3.fromRGB(221, 153, 85),
			TabTextColor = Color3.fromRGB(85, 51, 17),
			SelectedTabTextColor = Color3.fromRGB(85, 51, 17),

			ElementBackground = Color3.fromRGB(187, 136, 85),
			ElementBackgroundHover = Color3.fromRGB(170,119,51),
			SecondaryElementBackground = Color3.fromRGB(85, 51, 17), -- For labels and paragraphs
			ElementStroke = Color3.fromRGB(85, 51, 17),
			SecondaryElementStroke = Color3.fromRGB(170, 119, 51), -- For labels and paragraphs

			SliderBackground = Color3.fromRGB(85, 51, 17),
			SliderProgress = Color3.fromRGB(170,119,51),
			SliderStroke = Color3.fromRGB(187, 136, 85),

			ToggleBackground = Color3.fromRGB(85, 51, 17),
			ToggleEnabled = Color3.fromRGB(221, 153, 85),
			ToggleDisabled = Color3.fromRGB(170, 119, 51),
			ToggleEnabledStroke = Color3.fromRGB(85, 51, 17),
			ToggleDisabledStroke = Color3.fromRGB(85, 51, 17),
			ToggleEnabledOuterStroke = Color3.fromRGB(85, 51, 17),
			ToggleDisabledOuterStroke = Color3.fromRGB(85, 51, 17),

			InputBackground = Color3.fromRGB(85, 51, 17),
			InputStroke = Color3.fromRGB(170, 119, 51),
			PlaceholderColor = Color3.fromRGB(170, 119, 51)
		},
		Light = {
			TextFont = "Gotham", -- Default will use the various font faces used across Rayfield
			TextColor = Color3.fromRGB(85, 51, 17), -- i need to make all text 240, 240, 240 and base gray on transparency not color to do this
			...
			SliderBackground = Color3.fromRGB(85, 51, 17),
			SliderProgress = Color3.fromRGB(85, 51, 17),
			SliderStroke = Color3.fromRGB(170,119,51),

			ToggleBackground = Color3.fromRGB(170,119,51),
			ToggleEnabled = Color3.fromRGB(85, 51, 17),
			ToggleDisabled = Color3.fromRGB(170,119,51),
			ToggleEnabledStroke = Color3.fromRGB(85, 51, 17),
			ToggleDisabledStroke = Color3.fromRGB(85, 51, 17),
			ToggleEnabledOuterStroke = Color3.fromRGB(170,119,51),
			ToggleDisabledOuterStroke = Color3.fromRGB(170,119,51),

			InputBackground = Color3.fromRGB(85, 51, 17),
			InputStroke = Color3.fromRGB(85, 51, 17),
			PlaceholderColor = Color3.fromRGB(170,119,51)
		}
	}
}
...
function RayfieldLibrary:Notify(NotificationSettings)
	spawn(function()
		...
		TweenService:Create(Notification.Description, TweenInfo.new(0.8, Enum.EasingSt
